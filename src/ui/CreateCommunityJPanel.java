...
public class CreateCommunityJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        valCommunityName = new javax.swing.JLabel();
        valLandmark = new javax.swing.JLabel();
        valPinCode = new javax.swing.JLabel();
        valUpdateCommunityName = new javax.swing.JLabel();
        valUpdatePinCode = new javax.swing.JLabel();
        valUpdateLandmark = new javax.swing.JLabel();
        ...
        valCommunityName.setForeground(new java.awt.Color(255, 51, 51));

        valLandmark.setForeground(new java.awt.Color(255, 51, 51));

        valPinCode.setForeground(new java.awt.Color(255, 51, 51));

        valUpdateCommunityName.setForeground(new java.awt.Color(255, 51, 51));

        valUpdatePinCode.setForeground(new java.awt.Color(255, 51, 51));

        valUpdateLandmark.setForeground(new java.awt.Color(255, 51, 51));
                    ...
                    .addGroup(splitWorkspaceLayout.createSequentialGroup()
                        .addGroup(splitWorkspaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(splitWorkspaceLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(splitWorkspaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(valUpdateCommunityName)
                                    .addComponent(valUpdatePinCode)
                                    .addComponent(valUpdateLandmark)))
                            .addGroup(splitWorkspaceLayout.createSequentialGroup()
                                .addGap(130, 130, 130)
                                .addComponent(name2)
                                .addGap(18, 18, 18)
                                .addGroup(splitWorkspaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(valCommunityName)
                                    .addGroup(splitWorkspaceLayout.createSequentialGroup()
                                        ...
                                        .addGroup(splitWorkspaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addGroup(splitWorkspaceLayout.createSequentialGroup()
                                                ...
                                                .addGroup(splitWorkspaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addComponent(valLandmark)))
                                            .addGroup(splitWorkspaceLayout.createSequentialGroup()
                                                .addComponent(name4)
                                                .addGap(18, 18, 18)
                                                .addGroup(splitWorkspaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(valPinCode)
    ...
    private boolean validation() {
        ...
        String landMark = txtLandMark.getText();
        valCommunityName.setText("");
        valLandmark.setText("");
        valPinCode.setText("");

        //CityName Validation
        if (communityName.length() <= 0) {
            valCommunityName.setText("Please Enter Community Name");
            validation = false;
        }
        //stateName Validation
        if (pinCode.length() <= 0) {
            valPinCode.setText("Please Enter Pincode");
            validation = false;
        }
        //country Validation
        if (landMark.length() <= 0) {
            valLandmark.setText("Please Enter LandMark");
            validation = false;
        }
    ...
    private boolean updateValidation() {
        ...
        String communityName = txtUpdateCommunityName.getText();
        String pinCode = txtUpdatePinCode.getText();
        String landMark = txtUpdateLandMark.getText();
        valUpdateCommunityName.setText("");
        valUpdateLandmark.setText("");
        valUpdatePinCode.setText("");

        //CityName Validation
        if (communityName.length() <= 0) {
            valUpdateCommunityName.setText("Please Enter Community Name");
            validation = false;
        }
        //stateName Validation
        if (pinCode.length() <= 0) {
            valUpdatePinCode.setText("Please Enter Pincode");
            validation = false;
        }
        //country Validation
        if (landMark.length() <= 0) {
            valUpdateLandmark.setText("Please Enter LandMark");
            validation = false;
        }
    ...
    private javax.swing.JLabel valCommunityName;
    private javax.swing.JLabel valLandmark;
    private javax.swing.JLabel valPinCode;
    private javax.swing.JLabel valUpdateCommunityName;
    private javax.swing.JLabel valUpdateLandmark;
    private javax.swing.JLabel valUpdatePinCode;
